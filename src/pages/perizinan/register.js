...
const Register = () => {
  ...
  function getUsers2(kelas) {
    ...
    const getUsers = async (kelas) => {
      if (kelas == "") {
        ...
        setUsers(semuaMurid);
        const q = query(usersCollectionRef, where("role", "==", "wali kelas"));
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      tanggal: Yup.string().max(255).required("Tanggal is required"),
  ...
  return (
    <>
      <Head>
        <title>Perizinan Register</title>
      </Head>
      <Box
        component="main"
        sx={{
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl sx={{ m: 1, minWidth: 80 }}>
              ...
              <Select
                ...
                onChange={
                  (e) => {
                    formik.handleChange("kelas");
                    getUsers2(e.target.value);
                  }
                  // ;
                }
                autoWidth
